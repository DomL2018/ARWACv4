...
if __name__ == "__main__":
    ...
    for fname in imgs:
        ...
        sgmcolor=75
        sgmspace=75
        img = cv2.bilateralFilter(img,dims,sgmcolor,sgmspace)
        ...
        plt.figure('Tracking...')
        plt.title('binary and Intercept')
        ...
        print ('number of line segmets: = ',lines[0])
        for line in lines:
            x1,y1,x2,y2 = line[0]
