...
# two loop in backgound thread , working to be tested
# https://www.codegrepper.com/code-examples/python/python+two+while+loops+at+same+time
# https://code-maven.com/catch-control-c-in-python
# https://wellsr.com/python/python-multithreading-run-functions-in-parallel/
# https://www.codeproject.com/Articles/1236741/Python-Concurrency-Programming-Python-Synchronizat
...
def run(killed):       
    ...
    while m_CLanParams.key != 113 : #F2
        ...
        if err == sl.ERROR_CODE.SUCCESS :
            ...
            m_CLanParams.camera.retrieve_image(m_CLanParams.left_image, sl.VIEW.LEFT) # Left image 
            ...
            if ctrFlag == 1:
                ...
                # print ('\n Robot control offset {inter} and scaled as {externa}'.format(inter = round(msgi,3), externa = round(msg_scl,3)))
