...
class FullScreenApp(object):
    ...
    def run(self):
        ...
        left_frame = Frame(self.root, width=960, height=640, bg='grey')
        left_frame.pack(side='left', fill='both', padx=8, pady=4, expand=True)

        right_frame = Frame(self.root, width=256, height=640, bg='grey')
        right_frame.pack(side='right', fill='both', padx=8, pady=4, expand=True)

        # right_frame = Frame(root, width=650, height=400, bg='grey')
        # right_frame.pack(side='right', fill='both', padx=10, pady=5, expand=True)
        image=Image.open("/home/dom/ARWAC/Essa-0/20190206_141310.jpg")
