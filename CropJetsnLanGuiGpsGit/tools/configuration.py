...
class Configuration(object):
    # DEFAULT_CONFIGURATION_FILE_PATH = os.path.join(os.getcwd(), '/config/default_configuration.json')
    # CONFIGURATION_FILE_PATH = os.path.join(os.getcwd(), '/config/configuration.json')
    DEFAULT_CONFIGURATION_FILE_PATH = './config/default_configuration.json'
    CONFIGURATION_FILE_PATH = './config/configuration.json'
