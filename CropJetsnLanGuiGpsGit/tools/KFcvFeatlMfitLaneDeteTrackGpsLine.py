...
from tools.imagetranformDb import skim_ToplogicalSkel,GetStreeingInfo#,cv_ToplogicalSkel
...
class KFcvFeatlMfitLaneDeteTracks(CAlgrthmParams,CLanesParams):
    ...
    def get_lines_seg(self,segment,masked):    
        ...
        AngRet, lane_dic = GetStreeingInfo(mask_ske,segment,masked,self.LanesParams.lanebandwith*1.618)
    ...
    def draw_display(self,masked,lane_dic,cen_hight,width):
        ...
        for key, coords in enumerate(lane_dic):
    ...
    def MainDeteTrack(self,orig_frame):
        ...
        AngRet, lane_dic=self.get_lines_seg(regionofintrest,masked)
