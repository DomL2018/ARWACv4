...
class GUI(object):
    ...
    def add_LaneSetstatusbar(self):
        strfm = 'default: ' + str(m_CLanParams.SIMPNumoflaneInit)
    ...
    def add_LaneOriPtstatusbar(self):
        strfm = 'default: ' + str(m_CLanParams.SIMPLaneOriPoint)
    ...
    def add_LaneBandwithstatusbar(self):
        strfm = 'default: ' + str(m_CLanParams.SIMPbandwith)
    ...
    def add_minLineLengthstatusbar(self):
        strfm = 'default: ' + str(m_CLanParams.minLineLength_Smpl)
    ...
    def add_maxGapstatusbar(self):
        strfm = 'default: ' + str(m_CLanParams.maxLineGap_Smpl)
    ...
    def add_greenLowclorstatusbar(self):
        strfm = 'default: ' + str(m_CLanParams.HSVLowGreenClor_Smpl)
    ...
    def add_greenHigclorstatusbar(self):
        strfm = 'default: ' + str(m_CLanParams.HSVHighGreenClor_Smpl)
        # print('strfm',strfm)
    ...
    def add_greenLowSaturstatusbar(self):
        strfm = 'default: ' + str(m_CLanParams.HSVLowGreenSatur_Smpl)
        # print('strfm',strfm)
    ...
    def add_greenLowValstatusbar(self):
        strfm = 'default: ' + str(m_CLanParams.HSVLowGreenVal_Smpl)
        # print('strfm',strfm)
    ...
    def add_FullRGBRow0Statusbar(self):
        strfm = 'default: ' + str(m_CLanParams.SIMPRGBRow0)
        # print('strfm',strfm)
    ...
    def add_FullRGBH0Statusbar(self):
        strfm = 'default: ' + str(m_CLanParams.SIMPRGBH0)
        # print('strfm',strfm)
    ...
    def add_FullRGBCol0Statusbar(self):
        strfm = 'default: ' + str(m_CLanParams.SIMPRGBCol0)
        # print('strfm',strfm)
    ...
    def add_FullRGBW0Statusbar(self):
        strfm = 'default: ' + str(m_CLanParams.SIMPRGBW0)
        # print('strfm',strfm)
    ...
    def SetStart_Ctrl(self):
        ...
        """ 
        # global m_CFRGBLneTrcks
        # m_CFRGBLneTrcks.AgthmParams.ToIntializeSetting=False
        global m_CLneDTrcks
        m_CLneDTrcks.AgthmParams.ToIntializeSetting=False
    ...
    def add_ImgOffsetBar(self):
       ...
       """
        ...
        barvaule = m_CLanParams.SIMPOffset
        ...
        def callback(value):
            ...
            if self.m_OffsetCtrlBar == True:
                ...
                # m_CLanParams.SIMPOffset = m_CLanParams.FullRGBoffset + barvaule
                # m_CLanParams.FullDEPoffset = m_CLanParams.FullDEPoffset + barvaule
                bar["value"] = m_CLanParams.SIMPOffset#barvaule#int(value * 10)
                self.set_status("Image OffSet(<200 pixels): '{0:.3}'".format(str(m_CLanParams.SIMPOffset)))
            else:
                m_CLanParams.SIMPOffset = m_CLanParams.SIMPOffset - barvaule
                # m_CLanParams.FullRGBoffset = m_CLanParams.FullRGBoffset - barvaule
                # m_CLanParams.FullDEPoffset = m_CLanParams.FullDEPoffset - barvaule
                bar["value"] = m_CLanParams.SIMPOffset#barvaule#int(value * 10)
                self.set_status("Image OffSet(>0 pixels): '{0:.3}'".format(str(m_CLanParams.SIMPOffset)))
    ...
    def add_LaneSettingBar(self):
        ...
        # global m_CamParams 
        llbar = int(self.width*0.5)
        barvaule = m_CLanParams.SIMPNumoflaneInit
        ...
        def callback(value):
            ...
            if self.m_LaneSetCtrlBar == True:
                m_CLanParams.SIMPNumoflaneInit = m_CLanParams.SIMPNumoflaneInit + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                bar["value"] = m_CLanParams.SIMPNumoflaneInit#barvaule#int(value * 10)
                self.set_LaneSetstatus("Total Lane Num < 20): '{0:.2}'".format(str(m_CLanParams.SIMPNumoflaneInit)))
            else:
                m_CLanParams.SIMPNumoflaneInit = m_CLanParams.SIMPNumoflaneInit - barvaule
                bar["value"] = m_CLanParams.SIMPNumoflaneInit#barvaule#int(value * 10)
                self.set_LaneSetstatus("Total Lane Num > 0): '{0:.2}'".format(str(m_CLanParams.SIMPNumoflaneInit)))
    ...
    def add_LaneOriPtsBar(self):
        ...
        # global m_CamParams 
        llbar = int(self.width*0.5)
        barvaule = m_CLanParams.SIMPLaneOriPoint
        bar = ttk.Progressbar(master = self.filter_bar,
                                          orient = "horizontal",
                                          length = llbar,
                                          mode = "determinate",
        ...
        def callback(value):
            ...
            if self.m_LaneOriSetCtrlBar == True:
                m_CLanParams.SIMPLaneOriPoint = m_CLanParams.SIMPLaneOriPoint + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                bar["value"] = m_CLanParams.SIMPLaneOriPoint#barvaule#int(value * 10)
                self.set_LaneOriPtstatus("Lane Start Points < 200): '{0:.3}'".format(str(m_CLanParams.SIMPLaneOriPoint)))
            else:
                m_CLanParams.SIMPLaneOriPoint = m_CLanParams.SIMPLaneOriPoint - barvaule
                bar["value"] = m_CLanParams.SIMPLaneOriPoint#barvaule#int(value * 10)
                self.set_LaneOriPtstatus("Lane Start Points > 0): '{0:.3}'".format(str(m_CLanParams.SIMPLaneOriPoint)))
    ...
    def add_LaneBandwithBar(self):
        ...
        # global m_CamParams 
        llbar = int(self.width*0.5)
        barvaule = m_CLanParams.SIMPbandwith
        bar = ttk.Progressbar(master = self.filter_bar,
                                          orient = "horizontal",
                                          length = llbar,
                                          mode = "determinate",
        ...
        def callback(value):
            ...
            if self.m_LaneBandwithCtrlBar == True:
                m_CLanParams.SIMPbandwith = m_CLanParams.SIMPbandwith + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                bar["value"] = m_CLanParams.SIMPbandwith#barvaule#int(value * 10)
                self.set_LaneBandwithstatus("Lane Bandwith  < 200): '{0:.3}'".format(str(m_CLanParams.SIMPbandwith)))
            else:
                m_CLanParams.SIMPbandwith = m_CLanParams.SIMPbandwith - barvaule
                bar["value"] = m_CLanParams.SIMPbandwith#barvaule#int(value * 10)
                self.set_LaneBandwithstatus("Lane Bandwith > 0): '{0:.3}'".format(str(m_CLanParams.SIMPbandwith)))
    ...
    def add_minLineLengthBar(self):
        ...
        # global m_CamParams 
        llbar = int(self.width*0.5)
        barvaule = m_CLanParams.minLineLength_Smpl
        bar = ttk.Progressbar(master = self.filter_bar,
                                          orient = "horizontal",
                                          length = llbar,
                                          mode = "determinate",
        ...
        def callback(value):
            ...
            if self.m_minLineLengthCtrlBar == True:
                m_CLanParams.minLineLength_Smpl = m_CLanParams.minLineLength_Smpl + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                bar["value"] = m_CLanParams.minLineLength_Smpl#barvaule#int(value * 10)
                self.set_minLineLengthstatus("minLineLength  < 200): '{0:.3}'".format(str(m_CLanParams.minLineLength_Smpl)))
            else:
                m_CLanParams.minLineLength = m_CLanParams.minLineLength_Smpl - barvaule
                bar["value"] = m_CLanParams.minLineLength_Smpl#barvaule#int(value * 10)
                self.set_minLineLengthstatus("minLineLength > 0): '{0:.3}'".format(str(m_CLanParams.minLineLength_Smpl)))
    ...
    def add_maxGapBar(self):
        ...
        # global m_CamParams 
        llbar = int(self.width*0.5)
        barvaule = m_CLanParams.maxLineGap_Smpl
        bar = ttk.Progressbar(master = self.filter_bar,
                                          orient = "horizontal",
                                          length = llbar,
                                          mode = "determinate",
        ...
        def callback(value):
            ...
            if self.m_maxGapCtrlBar == True:
                m_CLanParams.maxLineGap_Smpl = m_CLanParams.maxLineGap_Smpl + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                bar["value"] = m_CLanParams.maxLineGap_Smpl#barvaule#int(value * 10)
                self.set_maxGapstatus("maxLineGap  < 200): '{0:.3}'".format(str(m_CLanParams.maxLineGap_Smpl)))
            else:
                m_CLanParams.maxLineGap_Smpl = m_CLanParams.maxLineGap_Smpl - barvaule
                bar["value"] = m_CLanParams.maxLineGap_Smpl#barvaule#int(value * 10)
                self.set_maxGapstatus("maxLineGap > 0): '{0:.3}'".format(str(m_CLanParams.maxLineGap_Smpl)))
    ...
    def add_greenLowclorBar(self):
            ...
            # global m_CamParams 
            llbar = int(self.width*0.5)
            barvaule = m_CLanParams.HSVLowGreenClor_Smpl
            bar = ttk.Progressbar(master = self.filter_bar,
                                            orient = "horizontal",
                                            length = llbar,
                                            mode = "determinate",
            ...
            def callback(value):
                ...
                if self.m_greenLowclorCtrlBar == True:
                    m_CLanParams.HSVLowGreenClor_Smpl = m_CLanParams.HSVLowGreenClor_Smpl + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    bar["value"] = m_CLanParams.HSVLowGreenClor_Smpl#barvaule#int(value * 10)
                    self.set_greenLowclorstatus("HSVLowGreenClor  < 180): '{0:.3}'".format(str(m_CLanParams.HSVLowGreenClor_Smpl)))
                else:
                    m_CLanParams.HSVLowGreenClor_Smpl = m_CLanParams.HSVLowGreenClor_Smpl - barvaule
                    bar["value"] = m_CLanParams.HSVLowGreenClor_Smpl#barvaule#int(value * 10)
                    self.set_greenLowclorstatus("HSVLowGreenClor > 25): '{0:.3}'".format(str(m_CLanParams.HSVLowGreenClor_Smpl)))
    ...
    def add_greenHigclorBar(self):
            ...
            # global m_CamParams 
            llbar = int(self.width*0.5)
            barvaule = m_CLanParams.HSVHighGreenClor_Smpl
            bar = ttk.Progressbar(master = self.filter_bar,
                                            orient = "horizontal",
                                            length = llbar,
                                            mode = "determinate",
            ...
            def callback(value):
                ...
                if self.m_greenHigclorCtrlBar == True:
                    m_CLanParams.HSVHighGreenClor_Smpl = m_CLanParams.HSVHighGreenClor_Smpl + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    bar["value"] = m_CLanParams.HSVHighGreenClor_Smpl#barvaule#int(value * 10)
                    self.set_greenHigclorstatus("HSVHigGreenClor  < 180): '{0:.3}'".format(str(m_CLanParams.HSVHighGreenClor_Smpl)))
                else:
                    m_CLanParams.HSVHighGreenClor_Smpl = m_CLanParams.HSVHighGreenClor_Smpl - barvaule
                    bar["value"] = m_CLanParams.HSVHighGreenClor_Smpl#barvaule#int(value * 10)
                    # print('m_CLanParams.HSVHighGreenClor=',m_CLanParams.HSVHighGreenClor)
                    self.set_greenHigclorstatus("HSVHigGreenClor > 25): '{0:.3}'".format(str(m_CLanParams.HSVHighGreenClor_Smpl)))
    ...
    def add_greenLowSaturBar(self):
            ...
            # global m_CamParams 
            llbar = int(self.width*0.5)
            barvaule = m_CLanParams.HSVLowGreenSatur_Smpl
            bar = ttk.Progressbar(master = self.filter_bar,
                                            orient = "horizontal",
                                            length = llbar,
                                            mode = "determinate",
            ...
            def callback(value):
                ...
                if self.m_greenLowSaturCtrlBar == True:
                    m_CLanParams.HSVLowGreenSatur_Smpl = m_CLanParams.HSVLowGreenSatur_Smpl + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    bar["value"] = m_CLanParams.HSVLowGreenSatur_Smpl#barvaule#int(value * 10)
                    self.set_greenLowSaturstatus("LowSatur  < 225): '{0:.3}'".format(str(m_CLanParams.HSVLowGreenSatur_Smpl)))
                else:
                    m_CLanParams.HSVLowGreenSatur_Smpl = m_CLanParams.HSVLowGreenSatur_Smpl - barvaule
                    bar["value"] = m_CLanParams.HSVLowGreenSatur_Smpl#barvaule#int(value * 10)
                    # print('m_CLanParams.HSVHighGreenClor=',m_CLanParams.HSVHighGreenClor)
                    self.set_greenLowSaturstatus("LowSatur > 25): '{0:.3}'".format(str(m_CLanParams.HSVLowGreenSatur_Smpl)))
    ...
    def add_greenLowValBar(self):
            ...
            # global m_CamParams 
            llbar = int(self.width*0.5)
            barvaule = m_CLanParams.HSVLowGreenVal_Smpl
            bar = ttk.Progressbar(master = self.filter_bar,
                                            orient = "horizontal",
                                            length = llbar,
                                            mode = "determinate",
            ...
            def callback(value):
                ...
                if self.m_greenLowValCtrlBar == True:
                    m_CLanParams.HSVLowGreenVal_Smpl = m_CLanParams.HSVLowGreenVal_Smpl + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    bar["value"] = m_CLanParams.HSVLowGreenVal_Smpl#barvaule#int(value * 10)
                    self.set_greenLowValstatus("HSVLowVal  < 225): '{0:.3}'".format(str(m_CLanParams.HSVLowGreenVal_Smpl)))
                else:
                    m_CLanParams.HSVLowGreenVal_Smpl = m_CLanParams.HSVLowGreenVal_Smpl - barvaule
                    bar["value"] = m_CLanParams.HSVLowGreenVal_Smpl#barvaule#int(value * 10)
                    # print('m_CLanParams.HSVLowGreenVal=',m_CLanParams.HSVLowGreenVal)
                    self.set_greenLowValstatus("HSVLowVal > 25): '{0:.3}'".format(str(m_CLanParams.HSVLowGreenVal_Smpl)))
    ...
    def add_FullRGBRow0Bar(self):
            ...
            # global m_CamParams 
            llbar = int(self.width*0.5)
            barvaule = m_CLanParams.SIMPRGBRow0
            bar = ttk.Progressbar(master = self.filter_bar,
                                            orient = "horizontal",
                                            length = llbar,
                                            mode = "determinate",
            ...
            def callback(value):
                ...
                if self.m_FullRGBRow0CtrlBar == True:
                    m_CLanParams.SIMPRGBRow0 = m_CLanParams.SIMPRGBRow0 + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    bar["value"] = m_CLanParams.SIMPRGBRow0#barvaule#int(value * 10)
                    self.set_FullRGBRow0Status("FullRGBRow0  < 500): '{0:.3}'".format(str(m_CLanParams.SIMPRGBRow0)))
                else:
                    m_CLanParams.SIMPRGBRow0 = m_CLanParams.SIMPRGBRow0 - barvaule
                    bar["value"] = m_CLanParams.SIMPRGBRow0#barvaule#int(value * 10)
                    # print('m_CLanParams.HSVLowGreenVal=',m_CLanParams.HSVLowGreenVal)
                    self.set_FullRGBRow0Status("FullRGBRow0 >= 0): '{0:.3}'".format(str(m_CLanParams.SIMPRGBRow0)))
    ...
    def add_FullRGBH0Bar(self):
            ...
            # global m_CamParams 
            llbar = int(self.width*0.5)
            barvaule = m_CLanParams.SIMPRGBH0
            bar = ttk.Progressbar(master = self.filter_bar,
                                            orient = "horizontal",
                                            length = llbar,
                                            mode = "determinate",
            ...
            def callback(value):
                ...
                if self.m_FullRGBH0CtrlBar == True:
                    m_CLanParams.SIMPRGBH0 = m_CLanParams.SIMPRGBH0 + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    bar["value"] = m_CLanParams.SIMPRGBH0#barvaule#int(value * 10)
                    self.set_FullRGBH0Status("FullRGBH0  < 1960): '{0:.3}'".format(str(m_CLanParams.SIMPRGBH0)))
                else:
                    m_CLanParams.FullRGBH0 = m_CLanParams.SIMPRGBH0 - barvaule
                    bar["value"] = m_CLanParams.SIMPRGBH0#barvaule#int(value * 10)
                    # print('m_CLanParams.HSVLowGreenVal=',m_CLanParams.HSVLowGreenVal)
                    self.set_FullRGBH0Status("FullRGBH0 >= 0): '{0:.3}'".format(str(m_CLanParams.SIMPRGBH0)))
    ...
    def add_FullRGBCol0Bar(self):
            ...
            # global m_CamParams 
            llbar = int(self.width*0.5)
            barvaule = m_CLanParams.SIMPRGBCol0
            bar = ttk.Progressbar(master = self.filter_bar,
                                            orient = "horizontal",
                                            length = llbar,
                                            mode = "determinate",
            ...
            def callback(value):
                ...
                if self.m_FullRGBCol0CtrlBar == True:
                    m_CLanParams.SIMPRGBCol0 = m_CLanParams.SIMPRGBCol0 + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    bar["value"] = m_CLanParams.SIMPRGBCol0#barvaule#int(value * 10)
                    self.set_FullRGBCol0Status("FullRGBCol0  < 1960): '{0:.3}'".format(str(m_CLanParams.SIMPRGBCol0)))
                else:
                    m_CLanParams.SIMPRGBCol0 = m_CLanParams.SIMPRGBCol0 - barvaule
                    bar["value"] = m_CLanParams.SIMPRGBCol0#barvaule#int(value * 10)
                    # print('m_CLanParams.HSVLowGreenVal=',m_CLanParams.HSVLowGreenVal)
                    self.set_FullRGBCol0Status("FullRGBCol0 >= 0): '{0:.3}'".format(str(m_CLanParams.SIMPRGBCol0)))
    ...
    def add_FullRGBW0Bar(self):
            ...
            # global m_CamParams 
            llbar = int(self.width*0.5)
            barvaule = m_CLanParams.SIMPRGBW0
            bar = ttk.Progressbar(master = self.filter_bar,
                                            orient = "horizontal",
                                            length = llbar,
                                            mode = "determinate",
            ...
            def callback(value):
                ...
                if self.m_FullRGBW0CtrlBar == True:
                    m_CLanParams.SIMPRGBW0 = m_CLanParams.SIMPRGBW0 + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    bar["value"] = m_CLanParams.SIMPRGBW0#barvaule#int(value * 10)
                    self.set_FullRGBW0Status("FullRGBW0  < 1960): '{0:.3}'".format(str(m_CLanParams.SIMPRGBW0)))
                else:
                    m_CLanParams.SIMPRGBW0 = m_CLanParams.SIMPRGBW0 - barvaule
                    bar["value"] = m_CLanParams.SIMPRGBW0#barvaule#int(value * 10)
                    # print('m_CLanParams.HSVLowGreenVal=',m_CLanParams.HSVLowGreenVal)
                    self.set_FullRGBW0Status("FullRGBW0 >= 0): '{0:.3}'".format(str(m_CLanParams.SIMPRGBW0)))
    ...
    def startproces(self,ArgAll):
        ...
        outputpth ='/home/dom/Documents/domReport/ref_images/Zedlivevideo.avi'
