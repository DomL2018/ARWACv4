...
class KFcvFeatlMfitLaneDeteTracks(CAlgrthmParams,CLanesParams):
    ...
    def MainDeteTrack(self,orig_frame):
        ...
        green_wheat = HSVFullEdgeProc(warped,low_green,high_green,'Dell7')
        PltShowing(green_wheat,'green_wheat','green_wheat', True, True)
        ...
        self.AgthmParams.video_image = detect#plt.imshow(res)
        # plt.pause(.1)
        # plt.draw()
