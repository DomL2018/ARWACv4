...
class GUI(object):
    ...
    def add_LaneSetstatusbar(self):
        strfm = 'default: ' + str(m_CLanParams.FullRGBNumRowsInit)
    ...
    def add_LaneOriPtstatusbar(self):
        strfm = 'default: ' + str(m_CLanParams.FullRGBLaneOriPoint)
    ...
    def add_LaneBandwithstatusbar(self):
        strfm = 'default: ' + str(m_CLanParams.FullRGBbandwith)
    ...
    def add_minLineLengthstatusbar(self):
        strfm = 'default: ' + str(m_CLanParams.minLineLength)
    ...
    def add_maxGapstatusbar(self):
        strfm = 'default: ' + str(m_CLanParams.maxLineGap)
    ...
    def add_FullRGBRow0Statusbar(self):
        strfm = 'default: ' + str(m_CLanParams.FullRGBRow0)
        # print('strfm',strfm)
    ...
    def add_FullRGBH0Statusbar(self):
        strfm = 'default: ' + str(m_CLanParams.FullRGBH0)
        # print('strfm',strfm)
    ...
    def add_FullRGBCol0Statusbar(self):
        strfm = 'default: ' + str(m_CLanParams.FullRGBCol0)
        # print('strfm',strfm)
    ...
    def add_FullRGBW0Statusbar(self):
        strfm = 'default: ' + str(m_CLanParams.FullRGBW0)
        # print('strfm',strfm)
    ...
    def add_ImgOffsetBar(self):
       ...
       """
        ...
        barvaule = m_CLanParams.FullRGBOffset
        ...
        def callback(value):
            ...
            if self.m_OffsetCtrlBar == True:
                ...
                self.set_status("Image OffSet(<200 pixels): '{0:.3}'".format(str(m_CLanParams.FullRGBoffset)))
            else:
                # m_CLanParams.SIMPOffset = m_CLanParams.SIMPOffset - barvaule
                m_CLanParams.FullRGBOffset = m_CLanParams.FullRGBOffset - barvaule
                # m_CLanParams.FullDEPoffset = m_CLanParams.FullDEPoffset - barvaule
                bar["value"] = m_CLanParams.FullRGBOffset#barvaule#int(value * 10)
                self.set_status("Image OffSet(>0 pixels): '{0:.3}'".format(str(m_CLanParams.FullRGBOffset)))
    ...
    def add_LaneSettingBar(self):
        ...
        # global m_CamParams 
        llbar = int(self.width*0.5)
        barvaule = m_CLanParams.FullRGBNumRowsInit
        ...
        def callback(value):
            ...
            if self.m_LaneSetCtrlBar == True:
                ...
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                bar["value"] = m_CLanParams.FullRGBNumRowsInit#barvaule#int(value * 10)
                self.set_LaneSetstatus("Total Lane Num < 20): '{0:.2}'".format(str(m_CLanParams.FullRGBNumRowsInit)))
            else:
                m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit - barvaule
                bar["value"] = m_CLanParams.FullRGBNumRowsInit#barvaule#int(value * 10)
                self.set_LaneSetstatus("Total Lane Num > 0): '{0:.2}'".format(str(m_CLanParams.FullRGBNumRowsInit)))
    ...
    def add_LaneOriPtsBar(self):
        ...
        # global m_CamParams 
        llbar = int(self.width*0.5)
        barvaule = m_CLanParams.FullRGBLaneOriPoint
        bar = ttk.Progressbar(master = self.filter_bar,
                                          orient = "horizontal",
                                          length = llbar,
                                          mode = "determinate",
        ...
        def callback(value):
            ...
            if self.m_LaneOriSetCtrlBar == True:
                m_CLanParams.FullRGBLaneOriPoint = m_CLanParams.FullRGBLaneOriPoint + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                bar["value"] = m_CLanParams.FullRGBLaneOriPoint#barvaule#int(value * 10)
                self.set_LaneOriPtstatus("Lane Start Points < 200): '{0:.3}'".format(str(m_CLanParams.FullRGBLaneOriPoint)))
            else:
                m_CLanParams.FullRGBLaneOriPoint = m_CLanParams.FullRGBLaneOriPoint - barvaule
                bar["value"] = m_CLanParams.FullRGBLaneOriPoint#barvaule#int(value * 10)
                self.set_LaneOriPtstatus("Lane Start Points > 0): '{0:.3}'".format(str(m_CLanParams.FullRGBLaneOriPoint)))
    ...
    def add_minLineLengthBar(self):
        ...
        # global m_CamParams 
        llbar = int(self.width*0.5)
        barvaule = m_CLanParams.minLineLength
        bar = ttk.Progressbar(master = self.filter_bar,
                                          orient = "horizontal",
                                          length = llbar,
                                          mode = "determinate",
        ...
        def callback(value):
            ...
            if self.m_minLineLengthCtrlBar == True:
                m_CLanParams.minLineLength = m_CLanParams.minLineLength + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                bar["value"] = m_CLanParams.minLineLength#barvaule#int(value * 10)
                self.set_minLineLengthstatus("minLineLength  < 200): '{0:.3}'".format(str(m_CLanParams.minLineLength)))
            else:
                m_CLanParams.minLineLength = m_CLanParams.minLineLength - barvaule
                bar["value"] = m_CLanParams.minLineLength#barvaule#int(value * 10)
                self.set_minLineLengthstatus("minLineLength > 0): '{0:.3}'".format(str(m_CLanParams.minLineLength)))
    ...
    def add_maxGapBar(self):
        ...
        # global m_CamParams 
        llbar = int(self.width*0.5)
        barvaule = m_CLanParams.maxLineGap
        bar = ttk.Progressbar(master = self.filter_bar,
                                          orient = "horizontal",
                                          length = llbar,
                                          mode = "determinate",
        ...
        def callback(value):
            ...
            if self.m_maxGapCtrlBar == True:
                m_CLanParams.maxLineGap = m_CLanParams.maxLineGap + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                bar["value"] = m_CLanParams.maxLineGap#barvaule#int(value * 10)
                self.set_maxGapstatus("maxLineGap  < 200): '{0:.3}'".format(str(m_CLanParams.maxLineGap)))
            else:
                m_CLanParams.maxLineGap = m_CLanParams.maxLineGap - barvaule
                bar["value"] = m_CLanParams.maxLineGap#barvaule#int(value * 10)
                self.set_maxGapstatus("maxLineGap > 0): '{0:.3}'".format(str(m_CLanParams.maxLineGap)))
    ...
    def add_FullRGBRow0Bar(self):
            ...
            # global m_CamParams 
            llbar = int(self.width*0.5)
            barvaule = m_CLanParams.FullRGBRow0
            bar = ttk.Progressbar(master = self.filter_bar,
                                            orient = "horizontal",
                                            length = llbar,
                                            mode = "determinate",
            ...
            def callback(value):
                ...
                if self.m_FullRGBRow0CtrlBar == True:
                    m_CLanParams.FullRGBRow0 = m_CLanParams.FullRGBRow0 + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    bar["value"] = m_CLanParams.FullRGBRow0#barvaule#int(value * 10)
                    self.set_FullRGBRow0Status("FullRGBRow0  < 500): '{0:.3}'".format(str(m_CLanParams.FullRGBRow0)))
                else:
                    m_CLanParams.FullRGBRow0 = m_CLanParams.FullRGBRow0 - barvaule
                    bar["value"] = m_CLanParams.FullRGBRow0#barvaule#int(value * 10)
                    # print('m_CLanParams.HSVLowGreenVal=',m_CLanParams.HSVLowGreenVal)
                    self.set_FullRGBRow0Status("FullRGBRow0 >= 0): '{0:.3}'".format(str(m_CLanParams.FullRGBRow0)))
    ...
    def add_FullRGBH0Bar(self):
            ...
            # global m_CamParams 
            llbar = int(self.width*0.5)
            barvaule = m_CLanParams.FullRGBH0
            bar = ttk.Progressbar(master = self.filter_bar,
                                            orient = "horizontal",
                                            length = llbar,
                                            mode = "determinate",
            ...
            def callback(value):
                ...
                if self.m_FullRGBH0CtrlBar == True:
                    m_CLanParams.FullRGBH0 = m_CLanParams.FullRGBH0 + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    bar["value"] = m_CLanParams.FullRGBH0#barvaule#int(value * 10)
                    self.set_FullRGBH0Status("FullRGBH0  < 1960): '{0:.3}'".format(str(m_CLanParams.FullRGBH0)))
                else:
                    m_CLanParams.FullRGBH0 = m_CLanParams.FullRGBH0 - barvaule
                    bar["value"] = m_CLanParams.FullRGBH0#barvaule#int(value * 10)
                    # print('m_CLanParams.HSVLowGreenVal=',m_CLanParams.HSVLowGreenVal)
                    self.set_FullRGBH0Status("FullRGBH0 >= 0): '{0:.3}'".format(str(m_CLanParams.FullRGBH0)))
    ...
    def add_FullRGBCol0Bar(self):
            ...
            # global m_CamParams 
            llbar = int(self.width*0.5)
            barvaule = m_CLanParams.FullRGBCol0
            bar = ttk.Progressbar(master = self.filter_bar,
                                            orient = "horizontal",
                                            length = llbar,
                                            mode = "determinate",
            ...
            def callback(value):
                ...
                if self.m_FullRGBCol0CtrlBar == True:
                    m_CLanParams.FullRGBCol0 = m_CLanParams.FullRGBCol0 + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    bar["value"] = m_CLanParams.FullRGBCol0#barvaule#int(value * 10)
                    self.set_FullRGBCol0Status("FullRGBCol0  < 1960): '{0:.3}'".format(str(m_CLanParams.FullRGBCol0)))
                else:
                    m_CLanParams.FullRGBCol0 = m_CLanParams.FullRGBCol0 - barvaule
                    bar["value"] = m_CLanParams.FullRGBH0#barvaule#int(value * 10)
                    # print('m_CLanParams.HSVLowGreenVal=',m_CLanParams.HSVLowGreenVal)
                    self.set_FullRGBCol0Status("FullRGBCol0 >= 0): '{0:.3}'".format(str(m_CLanParams.FullRGBCol0)))
    ...
    def add_FullRGBW0Bar(self):
            ...
            # global m_CamParams 
            llbar = int(self.width*0.5)
            barvaule = m_CLanParams.FullRGBW0
            bar = ttk.Progressbar(master = self.filter_bar,
                                            orient = "horizontal",
                                            length = llbar,
                                            mode = "determinate",
            ...
            def callback(value):
                ...
                if self.m_FullRGBW0CtrlBar == True:
                    m_CLanParams.FullRGBW0 = m_CLanParams.FullRGBW0 + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    # m_CLanParams.FullRGBNumRowsInit = m_CLanParams.FullRGBNumRowsInit + barvaule
                    bar["value"] = m_CLanParams.FullRGBW0#barvaule#int(value * 10)
                    self.set_FullRGBW0Status("FullRGBW0  < 1960): '{0:.3}'".format(str(m_CLanParams.FullRGBW0)))
                else:
                    m_CLanParams.FullRGBW0 = m_CLanParams.FullRGBW0 - barvaule
                    bar["value"] = m_CLanParams.FullRGBW0#barvaule#int(value * 10)
                    # print('m_CLanParams.HSVLowGreenVal=',m_CLanParams.HSVLowGreenVal)
                    self.set_FullRGBW0Status("FullRGBW0 >= 0): '{0:.3}'".format(str(m_CLanParams.FullRGBW0)))
