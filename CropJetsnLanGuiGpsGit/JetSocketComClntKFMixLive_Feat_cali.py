...
from tools.KFcvFeatMixLaneDeteTrack_cali import CKFcvFeatLneDetsTracks
...
def run(killed):       
    ...
    while m_CamParams.key != 113 : #F2: 
        ...
        if err == m_CamParams.sl.ERROR_CODE.SUCCESS:                      
            ...
            m_CamParams.cam.retrieve_image(m_CamParams.left_image, m_CamParams.sl.VIEW.LEFT, m_CamParams.sl.MEM.CPU, m_CamParams.image_size)#(m_CamParams.new_width, m_CamParams.new_height))
