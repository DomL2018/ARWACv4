...
def arwacmain(ArgAll):
    ...
    serial_handle = SerialComm(port,baudrate)  # get instance of serial commmunication interface
    pwm1=50
    pwm2=50
    ...
    if serial_handle.serialport_num>0:
        ...
        ser=serial_handle.startSerialCom(port, baudrate)    
        if (ser):
            serial_handle.runMotor(ser,0,pwm1,pwm2)
