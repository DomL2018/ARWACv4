...
class SerialComm(object):
    ...
    def __init__(self, port, baud_rate,timeout, debug='off', sector_size=DEFAULT_SECTOR_SIZE, page_size=1024):
    ...
    def startSerialCom(self,port_str, baudrate,timeout):
        ...
        try:
            ...
            self.sock  = serial.Serial(port=port_str, baudrate=baudrate, timeout=timeout)   
            ...
            if (self.sock ):
                ...
                time.sleep(1)  # Wait for the Reciever Device bootloader 
                return self.sock 
    ...
    def read_Data(self,ser, chunk_size=1):
