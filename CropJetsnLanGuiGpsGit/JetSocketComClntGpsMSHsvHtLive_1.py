...
def arwacmain(ArgAll):
    ...
    m_CLanParams.avi_height =720# m_CLanParams.h0#src_vid['frame_height']#=370   
    ...
    svRes = '/home/dom/Documents/ARWAC/robcontrl/04102021_100'
    if not os.path.exists(svRes):
        os.makedirs(svRes) 
    ...
    svRctRes=os.path.join(svRes, 'gui_'+timestr+'.avi')
